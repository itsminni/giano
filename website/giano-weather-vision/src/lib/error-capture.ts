// Keep the original error for SSR failures converted to HTTP responses.
...
// Retain the stack and cause chain in serialized logs.
...
// Capture errors logged by the server and h3.
